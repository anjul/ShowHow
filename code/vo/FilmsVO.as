package code.vo
{
	...
	{
		public static var smartStartMediaArr:Array=[];
		public static var beginnerMediaArr:Array=[];
		public static var intermediateMediaArr:Array=[];
		...
		public static const LEVEL_ADVANCED:String='advanced';		
	}
}